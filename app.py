...
authenticator = sauth.Authenticate(name, username, hashed_passwords,
                                   "app","auth",cookie_expiry_days = 30)


name,authentication_status, username = authenticator.login("Login", "main")

if authentication_status ==False:
    slt.error("Username/password is incorrect")
    
if authentication_status == None:
    slt.warning ("Please enter your username and password")
